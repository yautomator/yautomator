...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies_chroma_js: string;
	...
	export const npm_package_dependencies_svelte_flag_icons: string;
	export const npm_package_dependencies_svelte_tippy: string;
	export const npm_package_dependencies_tippy_js: string;
	export const npm_package_dependencies__aws_sdk_client_s3: string;
	...
	export const npm_package_devDependencies__types_chroma_js: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies_chroma_js: string;
		...
		npm_package_dependencies_svelte_flag_icons: string;
		npm_package_dependencies_svelte_tippy: string;
		npm_package_dependencies_tippy_js: string;
		npm_package_dependencies__aws_sdk_client_s3: string;
		...
		npm_package_devDependencies__types_chroma_js: string;
